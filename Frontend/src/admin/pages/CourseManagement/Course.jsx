...
const Course = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-xl mb-5 font-semibold text-left">All Courses </h1>
      ...
      {showAddForm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-5 text-center rounded shadow-lg w-[650px] h-auto mt-10 relative">
            <h1 className="text-lg font-semibold mb-5">Add New Course</h1>
        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
          ...
          {paginatedData.map((item) => (
            ...
            >
              ...
              <div className="py-3 text-center">Course Name</div>
              <div className="py-3 text-center">5,000</div>
