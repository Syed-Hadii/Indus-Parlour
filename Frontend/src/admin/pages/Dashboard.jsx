...
const Dashboard = () => {
  return (
    <div className="p-6">
      ...
      <div className="w-full lg:w-[65%] h-auto lg:h-40 flex flex-wrap lg:flex-nowrap justify-between items-center gap-4">
        <div className="border-white bg-white rounded-md w-full lg:w-[48%] h-28 flex items-center justify-between px-4">
